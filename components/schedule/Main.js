...
const Screen = tw`flex flex-col items-center justify-start min-h-screen rtl pt-16 bg-linear-to-tl from-green-100/50 via-teal-100/50 to-cyan-100/50`;
const Container = tw`w-[80vw] relative`;
