...
export const DashboardPanelButton = tw`text-xs text-stone-500 hover:bg-secondary-400 hover:text-white rounded-full
    px-3 md:px-4 py-2 cursor-pointer transition-colors duration-200 whitespace-nowrap flex-shrink-0
    ${props => props.$active ? 'bg-secondary-600 text-white font-semibold' : ''}
`;
