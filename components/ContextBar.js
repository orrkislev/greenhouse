...
export default function ContextBar({ name, children, initialOpen = true }) {
    ...
    return (
        <div className={`hidden md:flex mt-2 p-2 flex-col bg-white transition-all duration-500  border border-gray-200 rounded-tr-lg ${isOpen ? 'min-w-64 w-64' : 'min-w-12 w-12'
            }`}>
