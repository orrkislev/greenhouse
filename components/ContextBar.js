...
export const PageMain = tw`flex-1 h-screen pt-4 md:pt-8 px-2 md:px-4 pb-24 overflow-y-auto relative`
...
export const BGGrads = ({ ammount = 20, opacity = 0.2 }) => {
    ...
    return (
        // <div className="absolute inset-0 opacity-20 bg-gradient-to-l from-white to-transparent" >
