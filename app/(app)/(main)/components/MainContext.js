...
export function ChangePasswordButton() {
    ...
    return (
        <div className={`flex flex-col justify-center items-center w-full rounded-lg p-4 ${open ? 'border border-destructive/30' : ''}`}>
            <Button data-role="edit" className="flex gap-2 cursor-pointer border text-destructive border-destructive p-2 hover:bg-destructive/10 transition-all duration-300 text-xs group"
                ...
                <div className="group-hover:text-destructive group-hover:pr-1 transition-all duration-300">
            ...
            {open && (
                <div className="flex flex-col gap-2 p-2 justify-center items-center w-full">
                    ...
                    <div className={`relative w-full border border-destructive hover:border-destructive transition-all overflow-hidden cursor-pointer bg-destructive/60 text-white flex items-center justify-center p-2 rounded-md ${error ? "shake" : ""}`} onClick={onClick}>
                        <div className="absolute left-0 top-0 h-full bg-destructive transition-all duration-300 z-0"
                            style={{
